          ...
          <thead>
            <tr>
              {Object.values(FormCategory).map((category) => (
                <th
                  key={category}
                  className="px-6 py-3 px-4 pt-4 pb-2 text-center text-xs font-medium text-gray-900 uppercase tracking-wider align-top bg-gradient-to-r from-coral-400 to-pink-400 rounded-t-lg border-t border-x border-coral-200 border-b-0 relative z-10 "
                >
